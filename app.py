...
st.set_page_config(layout="wide", page_title='LAS Visualization Tool')
...
st.sidebar.write('To begin using the app, load your LAS file using the "Browse files" option below.')
